...
public class Assets implements Disposable, AssetErrorListener {
    ...
    public class ExplosionAssets {
        ...
        public ExplosionAssets(TextureAtlas atlas) {
            ...
            Array<AtlasRegion> explosionRegions = new Array<>();
            ...
            explosion = new Animation(Constants.EXPLOSION_DURATION / explosionRegions.size, explosionRegions, PlayMode.NORMAL);
        }
    }
    ...
    public class ExitPortalAssets {
        ...
        public ExitPortalAssets(TextureAtlas atlas) {
            ...
            Array<AtlasRegion> exitPortalFrames = new Array<>();
